...
class EnterprisesControllerTest < ActionController::TestCase
  ...
  test "should create enterprise" do
    assert_difference('Enterprise.count') do
      post :create, enterprise: { cnpj: @enterprise.cnpj, description: @enterprise.description, email: @enterprise.email, name: @enterprise.name, telephone: @enterprise.telephone }
    end
  ...
  test "should update enterprise" do
    put :update, id: @enterprise, enterprise: { cnpj: @enterprise.cnpj, description: @enterprise.description, email: @enterprise.email, name: @enterprise.name, telephone: @enterprise.telephone }
    assert_redirected_to enterprise_path(assigns(:enterprise))
  end
